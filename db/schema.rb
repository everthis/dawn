...
ActiveRecord::Schema.define(version: 20160529025350) do
  ...
  add_index "third_party_accounts", ["user_id", "created_at"], name: "index_third_party_accounts_on_user_id_and_created_at", using: :btree
