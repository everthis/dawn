    ...
    ajax: function ajax(method, url) {
      ...
      var promise = new Promise(function (resolve, reject) {
        ...
        if (method === 'POST' || method === 'PUT' || method === 'PATCH' || method === 'DELETE') {
          var uri = JSON.stringify(extendGeneralParams(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utilities__["b" /* wrapObj */])(args, prefix)));
          client.open(method, url);
          // client.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
          client.setRequestHeader('Content-type', 'application/json');
          client.send(uri);
        } else if (method === 'GET') {
          var _uri = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__serialize__["a" /* serialize */])(extendGeneralParams(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utilities__["c" /* addPrefixToObj */])(args, prefix)));
...
function extendGeneralParams(obj) {
  var csrfParam = __WEBPACK_IMPORTED_MODULE_2__csrf__["a" /* rorParams */].csrfParam();
  var csrfToken = __WEBPACK_IMPORTED_MODULE_2__csrf__["a" /* rorParams */].csrfToken();
  var generalObj = {};
  generalObj.utf8 = '✓';
  generalObj.format = 'json';
  generalObj[csrfParam] = csrfToken;
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utilities__["d" /* mergeObj */])(obj, generalObj);
}
// End A
...
function flash(data) {
  ...
  var flashEle = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utilities__["e" /* strToDom */])(flashTpl(data));
...
function popup(ev, params, callback) {
  ...
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__toggleScroll__["a" /* disableScroll */])();
}
...
function closePopup(ev) {
  ...
  if (popLayer) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__toggleScroll__["b" /* enableScroll */])();
  }
}
...
Tree.prototype.traverseBF = function (callback) {
  var queue = new __WEBPACK_IMPORTED_MODULE_0__queue__["a" /* Queue */]();
...
/***/ }),
/* 36 */
/* exports provided: twoWayDataBinding */
/* exports used: twoWayDataBinding */
/*!**********************************************************!*\
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = twoWayDataBinding;
...
/***/ }),
/* 37 */
/* exports provided: rootAPI */
/* exports used: rootAPI */
/*!*************************************************!*\
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return rootAPI; });
...
/* 44 */,
/* 45 */
/* exports provided: initApiOperation, disposeApiOperation */
/* exports used: initApiOperation, disposeApiOperation */
/*!******************************************************!*\
...
var callback = {
  ...
  patchSuccess: function patchSuccess(data) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__common_flash__["a" /* parseAndFlash */])(data);
  },
  ...
  deleteSuccess: function deleteSuccess(data) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__common_flash__["a" /* parseAndFlash */])(data, destoryApiLi.bind(this));
  },
...
var debouncedApiQueryInput = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__common_utilities__["a" /* debounce */])(apiQuery, 100, false);
...
function apiQuery(ev) {
  ...
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_ajax__["a" /* $http */])(window.location.origin + '/instantsearch').get(payload).then(callback.apiQuerySuccess.bind(ev)).catch(callback.error);
}
...
function bindEventToApiLiDescription(ev) {
  ...
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_ajax__["a" /* $http */])(__WEBPACK_IMPORTED_MODULE_1__global_constant__["a" /* rootAPI */] + '/' + this.parentNode.dataset.apiId).get(payload).then(callback.getApiSuccess.bind(this.parentNode)).catch(callback.error);
}
function bindevents() {
...
function addApiTree() {
  ...
  var newApi = new __WEBPACK_IMPORTED_MODULE_7__api_tree_treeDom__["a" /* ApiDom */](data, containerNode, isNewApi);
  apisArr.push(newApi);
}

var debouncedNewApiBtn = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__common_utilities__["a" /* debounce */])(processNewApiClick, 500, true);
var debouncedEnvBtn = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__common_utilities__["a" /* debounce */])(processOpenEnvSettings, 500, true);
function processOpenEnvSettings(ev, el) {
  var params = {
    content: slideContent()
  };
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__common_slide__["a" /* slide */])(ev, params);
}
...
function processNewApiClick() {
  ...
  var baseApiLi = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__common_utilities__["e" /* strToDom */])(newApiLiTpl());
...
function createApiUl() {
  ...
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__common_utilities__["f" /* insertAfter */])(apiListEle, newApiDiv);
}
function newApiBtn() {
...
function renderAllApis(data) {
  ...
  var tmpl = function tmpl(data) {
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__common_template__["a" /* html */])(_templateObject, data.map(function (item) {
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__common_template__["a" /* html */])(_templateObject2, newApiLiTpl(item));
    }));
  };
  var apiListEle = document.createElement('div');
  apiListEle.classList.add('api-ul-wrapper');
  apiListEle.innerHTML = tmpl(data);
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__common_utilities__["f" /* insertAfter */])(apiListEle, newApiBtn());
}

function getAllApis() {
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_ajax__["a" /* $http */])(__WEBPACK_IMPORTED_MODULE_1__global_constant__["a" /* rootAPI */]).get(payload).then(callback.getAllApisSuccess).catch(callback.error);
}
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = jsonToTree;
/* unused harmony export treeToJson */
...
function jsonToTree(nodesArr) {
  ...
  tree = new __WEBPACK_IMPORTED_MODULE_0__tree__["a" /* Tree */](rootNodeData);
...
function collectApiData(tree, opEle) {
  ...
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_utilities__["d" /* mergeObj */])(collectInfo(perApiEle), collectDataFromTree(tree));
}
...
function perApiTpl(data) {
  ...
  var apiUUID = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_11__common_utilities__["g" /* generateUUID */])();
...
var callback = {
  patchSuccess: function patchSuccess(data) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__common_flash__["a" /* parseAndFlash */])(data);
  },
  postSuccess: function postSuccess(data) {
    this.apiRawData = data;
    this.apiDataObj = JSON.parse(data).data;
  ...
  deleteSuccess: function deleteSuccess(data) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__common_flash__["a" /* parseAndFlash */])(data, destoryApiLi.bind(this));
  },
  success: function success(data) {},
  error: function error(data) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__common_flash__["a" /* parseAndFlash */])(data);
  ...
  apiRespondSuccess: function apiRespondSuccess(data) {
    ...
    switchPreview(this.previewDataObj, __WEBPACK_IMPORTED_MODULE_6__utilities__["a" /* hightlightJSON */], this.eventContext, 'highlight');
  }
};
...
function ApiDom(data, containerNode) {
  ...
  var apiBindData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__common_twoWayDataBinding__["a" /* twoWayDataBinding */])(data, this.apiContainer);
  data = apiBindData;
  ...
  this.scrollBar = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_10__common_scroll__["a" /* scrollBarH */])({
...
ApiDom.prototype.renderExistTree = function (data) {
  ...
  if (data.nodes && data.nodes.length) {
    ...
    for (var i = 0, len = nodesArr.length; i < len; i++) {
      ...
      perTWDB = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__common_twoWayDataBinding__["a" /* twoWayDataBinding */])(data.nodes[i].data, leaf);
  ...
  this.apiTree = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__jsonTreeConverter__["a" /* jsonToTree */])(data.nodes);
...
function bindEvent(ev) {
  ...
  if (evTargetClassList.contains('api-save')) {
    var params = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__treeDataCollect__["a" /* collectApiData */])(_this.apiTree, _this.$apiTree);
    if (this.apiDataObj.id) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_ajax__["a" /* $http */])(__WEBPACK_IMPORTED_MODULE_3__global_constant__["a" /* rootAPI */] + '/' + this.apiDataObj.id).patch(params, 'api').then(callback.patchSuccess.bind(this)).catch(callback.error);
    } else if (!this.apiDataObj.id) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_ajax__["a" /* $http */])(__WEBPACK_IMPORTED_MODULE_3__global_constant__["a" /* rootAPI */]).post(params, 'api').then(callback.postSuccess.bind(this)).catch(callback.error);
    }
    return null;
  };
  ...
  if (evTargetClassList.contains('remove-child')) {
    if (ev.target.parentElement.classList.contains('root-leaf')) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__common_popup__["a" /* popup */])(ev, {}, deleteApi.bind(_this, ev));
    } else {
      _this.delNode(ev);
    }
    return null;
  ...
  if (evTargetClassList.contains('api-respond-preview-btn')) {
    if (!this.apiDataObj.id) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__common_flash__["b" /* flash */])({ error: 'Save first.' });
      return null;
    };
    var _params = { dawn_uri: this.apiDataObj.uri };
    var context = {};
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_ajax__["a" /* $http */])(window.location.origin + '/apiresponse').get(_params).then(callback.apiRespondSuccess.bind(this)).catch(callback.error);
    return null;
  };
  ...
  if (evTargetClassList.contains('preview-beautify')) {
    return switchPreview(this.previewDataObj, __WEBPACK_IMPORTED_MODULE_6__utilities__["b" /* beautifyJSON */], this.eventContext, 'beautify');
  };

  if (evTargetClassList.contains('preview-highlight')) {
    return switchPreview(this.previewDataObj, __WEBPACK_IMPORTED_MODULE_6__utilities__["a" /* hightlightJSON */], this.eventContext, 'highlight');
  };
}
...
function deleteApi(ev) {
  ...
  var params = {};
  console.log(__WEBPACK_IMPORTED_MODULE_3__global_constant__["a" /* rootAPI */]);
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_ajax__["a" /* $http */])(__WEBPACK_IMPORTED_MODULE_3__global_constant__["a" /* rootAPI */] + '/' + this.apiDataObj.id).delete(params).then(__WEBPACK_IMPORTED_MODULE_9__common_callbacks__["a" /* callbacks */].deleteSuccess.bind(ev)).catch(__WEBPACK_IMPORTED_MODULE_9__common_callbacks__["a" /* callbacks */].error);
}
...
ApiDom.prototype.initApiTree = function () {
  ...
  this.apiTree = new __WEBPACK_IMPORTED_MODULE_0__tree__["a" /* Tree */](initData);
  ...
  var callback = function callback(node) {
    ...
    leafBindData = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__common_twoWayDataBinding__["a" /* twoWayDataBinding */])(leafDataPlaceHolder, leafEle);
...
ApiDom.prototype.addChild = function (ctx) {
  ...
  var childModel = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__common_twoWayDataBinding__["a" /* twoWayDataBinding */])(leafDataPlaceHolder, leafChild);
  var leafData = {
...
"use strict";
/* unused harmony export getMaxOfArray */
/* unused harmony export hasClass */
/* unused harmony export browserPrefix */
/* unused harmony export getTransform */
/* unused harmony export getTranslateX */
/* unused harmony export getTranslateY */
/* harmony export (immutable) */ __webpack_exports__["b"] = beautifyJSON;
/* harmony export (immutable) */ __webpack_exports__["a"] = hightlightJSON;
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
var callbacks = {
  deleteSuccess: function deleteSuccess(data) {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__flash__["a" /* parseAndFlash */])(data, destoryApiLi.bind(this));
  },
  success: function success(data) {},
  error: function error(data) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__flash__["a" /* parseAndFlash */])(data);
  }
};
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = htmlEscape;
...
function a(x) {
  ...
  var newScrollEle = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utilities__["e" /* strToDom */])(newScrollStr);
  ...
  var debouncedWindowResize = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utilities__["a" /* debounce */])(reRender, 200, false);
...
function clickShadow(ev) {
  if (ev.target !== ev.currentTarget) return;
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_popup__["a" /* popup */])(ev, undefined, closeSlide.bind(this, ev));
}
...
function html(literalSections) {
  ...
  substs.forEach(function (subst, i) {
    ...
    if (lit.endsWith('$')) {
      subst = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__htmlEscape__["a" /* htmlEscape */])(subst);
      lit = lit.slice(0, -1);
    }
    result += lit;
    result += subst;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_apiOperation__ = __webpack_require__(/*! ../modules/apiOperation */ 45);

(function () {
  A.init[A.gc.currentName] = __WEBPACK_IMPORTED_MODULE_0__modules_apiOperation__["a" /* initApiOperation */];
  A.destroy[A.gc.currentName] = __WEBPACK_IMPORTED_MODULE_0__modules_apiOperation__["b" /* disposeApiOperation */];
})();
