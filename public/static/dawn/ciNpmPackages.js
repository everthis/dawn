...
/***/ 46:
/* exports provided: ciNpmPackages, exitCiNpmPackages */
/* exports used: ciNpmPackages, exitCiNpmPackages */
/*!*******************************************************!*\
...
var debouncedApiQueryInput = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__common_utilities__["a" /* debounce */])(apiQuery, 100, false);
...
function apiQuery(ev) {
  ...
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_ajax__["a" /* $http */])(window.location.origin + '/plugins_instantsearch').get(payload).then(callback.apiQuerySuccess.bind(ev)).catch(callback.error);
}
...
__WEBPACK_IMPORTED_MODULE_2_vue__["a" /* default */].component('packages', {
  data: function data() {
    return {
      pluginsInput: gc,
      showLogs: false
...
function ciNpmPackages() {
  ...
  vueApp = new __WEBPACK_IMPORTED_MODULE_2_vue__["a" /* default */]({
    el: '#app'
  });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_ciNpmPackages__ = __webpack_require__(/*! ../modules/ciNpmPackages */ 46);

(function () {
  A.init[A.gc.currentName] = __WEBPACK_IMPORTED_MODULE_0__modules_ciNpmPackages__["a" /* ciNpmPackages */];
  A.destroy[A.gc.currentName] = __WEBPACK_IMPORTED_MODULE_0__modules_ciNpmPackages__["b" /* exitCiNpmPackages */];
})();
