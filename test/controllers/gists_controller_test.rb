...
class GistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gist" do
    assert_difference('Gist.count') do
      post gists_url, params: { gist: { answer: @gist.answer, content: @gist.content, description: @gist.description, hasAnswer: @gist.hasAnswer } }
    end
  ...
  test "should update gist" do
    patch gist_url(@gist), params: { gist: { answer: @gist.answer, content: @gist.content, description: @gist.description, hasAnswer: @gist.hasAnswer } }
