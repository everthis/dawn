class ApisController < ApplicationController
  ...
  private
    ...
    def api_params
      params.require(:api).permit([:method, :name, :description, :uri, :section, {nodes: [:nodeId, :key, :column, :childrenlevel, :totaloffsetylevel, :parentId, :quantity, :value, :data]}, {dimensions: [:hUnit, :vUnit]} ])
    end
