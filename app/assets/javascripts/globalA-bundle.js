...
var _pubsub = __webpack_require__(32);
...
var _tasks = __webpack_require__(23);
...
var _dataset = __webpack_require__(29);
...
var _globalA = __webpack_require__(71);

var _globalA2 = _interopRequireDefault(_globalA);

var _ActionCable = __webpack_require__(45);

var _entry = __webpack_require__(60);

var _entry2 = _interopRequireDefault(_entry);

var _dataLinks = __webpack_require__(55);

var _postHandler = __webpack_require__(57);
...
var _xhr = __webpack_require__(64);
...
spfNavRequest.handleChunkFromXHR_ = function (url, options, timing, chunking, xhr, chunk, opt_lastDitch) {
  _debug2.default.debug('nav.request.handleChunkFromXHR_ ', url, { 'extra': chunking.extra, 'chunk': chunk });
...
spfNavRequest.handleCompleteFromXHR_ = function (url, options, timing, chunking, xhr) {
  if (xhr.responseType == 'json') {
    ...
    _debug2.default.debug('nav.request.handleCompleteFromXHR_ ', url, { 'extra': chunking.extra, 'complete': xhr.responseText });
  }
...
spfNavRequest.setCacheObject_ = function (cacheKey, response, type) {
  ...
  _cache2.default.set(cacheKey, cacheValue, /** @type {number} */_config2.default.get('cache-lifetime'));
};
